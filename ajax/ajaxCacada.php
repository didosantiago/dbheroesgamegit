    ...
    if(isset($_POST['id']) && $_POST['id'] != ''){
        ...
        if($stmt->rowCount() > 0){
            ...
            if($tempo_restante > 0){
                ...
                // Get character data from CORRECT table
                ...
                // Update character gold and exp in CORRECT table
                ...
                // Check for level up - Method will handle it if it exists
                ...
                // Return 0 to trigger page reload
                echo "0";
            }
        } else {
            echo "0";
